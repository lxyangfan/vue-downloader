...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return toQueryUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getQueryParam; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__asset_api__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__service_excel__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_network__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__asset_api__ = __webpack_require__(0);
...
var onBtnClick = function (event) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_2__utils_network__["b" /* post */])(req, function (data) {
        // got uuid, show it
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#uuid').html(data.uuid);
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').text('excel文件正在导出中，下载链接稍后出现，请等待...');
        uuid = data.uuid;
...
var queryStatus = function () {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_2__utils_network__["b" /* post */])(req, function (data) {
        ...
        if (!_.isEmpty(body) && body['flag'] === 2) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').text('生成excel失败：查询数据库出错！');
            clearInterval(cleanIntervalFlag);
        }
        if (!_.isEmpty(body) && body['flag'] === 1) {

            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').text('生成excel文件成功！');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#download').css({ 'display': 'block' });
            var downlink = Object(__WEBPACK_IMPORTED_MODULE_1__service_excel__["b" /* getDownloadLink */])(uuid);
            console.log(downlink);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#download-link').attr('href', downlink);
...
var cleanMsg = function () {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#message').text('');
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#download').css({ 'display': 'none' });
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#download-link').attr('href', '#');
}
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).on('hashchange', function () {
    asyncRequest = Object(__WEBPACK_IMPORTED_MODULE_1__service_excel__["a" /* getAsyncReqParam */])();
    cleanMsg();
    console.log(asyncRequest);
});
// 响应配置url诸如 http://xxx/index.html/?functionId=123&param1=xxx
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(window).on('beforeunload', function () {
    //.. work ..
    asyncRequest = Object(__WEBPACK_IMPORTED_MODULE_1__service_excel__["a" /* getAsyncReqParam */])();
    cleanMsg();
    console.log(asyncRequest);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#btnExportExcel').on('click', asyncRequest, onBtnClick);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getAsyncReqParam; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getDownloadLink; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__asset_api__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_network__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_lodash__);



var conf = __WEBPACK_IMPORTED_MODULE_0__asset_api__["a" /* api */]['dev'];
function getAsyncReqParam() {
    var params = Object(__WEBPACK_IMPORTED_MODULE_1__utils_network__["a" /* getQueryParam */])(window.location.href);
    var functionId = __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.isEmpty(params['functionId']) ? null : params['functionId'];
    var inputs = {};
    for (var item in params) {
        if (params.hasOwnProperty(item) && !__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.isEmpty(params[item]) && !__WEBPACK_IMPORTED_MODULE_2_lodash___default.a.isEqual(item, "functionId")) {
...
function getDownloadLink(uuid) {
    ...
    return conf['download'] + Object(__WEBPACK_IMPORTED_MODULE_1__utils_network__["c" /* toQueryUrl */])(params);
}
